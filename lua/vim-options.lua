...
-- Schedule the setting after 'UIEnter because it can ingrease startup-time
...
-- set tab to actually be spaces
vim.o.expandtab = true
-- Set the tabs to be four spaces instead of eight
vim.o.tabstop = 4
vim.o.softtabstop = 4
vim.o.shiftwidth = 4
